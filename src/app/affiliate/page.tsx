...
export default function AffiliatePage() {
    return (
        <main className="pb-16">
            {/* Hero Section */}
            <div className="container mx-auto px-4 text-center max-w-4xl pt-12">
                <div className="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors border-transparent bg-green-600 text-white mb-6">
                    Now Live
                </div>
